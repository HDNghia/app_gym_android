...
public class payment_user_post extends NavActivity {
    ...
    public void post(int courseId) {
        ...
        CourseRegister courseReg = new CourseRegister(courseId, ul.get(0).get_id(), new Date().getTime(), true);
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                if (response.isSuccessful()) {
                    Log.d("POST", "SUCCESS");
                    Intent foodIntent = new Intent(payment_user_post.this, course_user_gets.class);
